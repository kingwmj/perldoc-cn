...
然而, 我们还得把Gilligan手中的持有的菠萝数量与其它castaway成员手中持有的菠萝数目相比较.  比如, 假定我们对比的是Ginger和Gilligan. We ask the monkey about Ginger, get a number back, and then ask the monkey about Gilligan. . . again. 这可能会让猴烦不胜烦, 因为我们早前已经问过它了.  但我们必须再二再三, 再三再四地为每个值去问, 直到把七个值排顺. 
