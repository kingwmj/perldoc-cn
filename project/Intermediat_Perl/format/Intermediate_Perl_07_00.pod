...
=CN 第七章 对子程序的引用
=EN So far, you have seen references to three main Perl data types: scalars, arrays, and hashes. We can also take a reference to a subroutine (sometimes called a coderef). 
