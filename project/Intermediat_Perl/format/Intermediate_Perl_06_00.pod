=EN Manipulating Complex Data Structures
=CN 处理复杂数据结构
=EN Now that you've seen the basics of references, let's look at additional ways to manipulate complex data.
...
=CN 首先, 我们会用测试工具来查看复杂数据结构的内容, 之后我们会介绍Data::Dumper模块, 这样我们就可以在程序中展示数据结构了. 
...
=CN 下一步, 我们将会学到用Storable模块把复杂数据结构方便快捷地进行存取. 最后, 我们会回顾一下grep和map, 看他们如何在处理复杂数据结构上来发挥作用. 
