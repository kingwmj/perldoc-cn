=head2 Chapter 2. Intermediate Foundations 
...
=head2 2. 1. 1. List Filtering with grep 
...
=head2 2. 1. 2. Transforming Lists with map 
...
=head2 2. 2. Trapping Errors with eval 
...
=head2 2. 3. Dynamic Code with eval 
