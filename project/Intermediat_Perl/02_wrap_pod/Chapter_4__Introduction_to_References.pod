=head2 Chapter 4. Introduction to References 
...
=head2 4. 1. Performing the Same Task on Many Arrays 
...
=head2 4. 2. Taking a Reference to an Array 
...
=head2 4. 3. Dereferencing the Array Reference 
...
=head2 4. 4. Getting Our Braces Off 
...
=head2 4. 6. Nested Data Structures 
...
=head2 4. 7. Simplifying Nested Element References with Arrows 
...
=head2 4. 8. References to Hashes 
