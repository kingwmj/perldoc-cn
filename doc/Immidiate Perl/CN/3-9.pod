...
unshift @INC, ‘/home/gilligan/lib’;   # 错误 
use Navigation::SeatOfPants; 
...
[*]这样，lib编译提示取一个或多个参数，并且把他们加入数组@INC开头，就像前面所说的用unshift的效果一样。[*]之所以有效是因为它在编译期间执行而不是在运行时执行。接下来正是时候立即用use了。
...
use lib ‘/home/gilligan/lib/Navigation/SeatOfPants.pm’; # 错误！
