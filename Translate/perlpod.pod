...
=over
 ...
 C<=head1 I<Heading Text>>
X<=head1> X<=head2> X<=head3> X<=head4>
X<head1> X<head2> X<head3> X<head4>

 C<=head2 I<Heading Text>>

 C<=head3 I<Heading Text>>

 C<=head4 I<Heading Text>>
...
paragraph or a verbatim paragraph.  For example:
 ...
 C<=begin I<formatname>>
X<=begin> X<=end> X<=for> X<begin> X<end> X<for>

 C<=end I<formatname>>

 C<=for I<formatname> I<text...>>
...
=back
 ...
 C<EE<lt>escapeE<gt>> -- a character escape
...
Example: C<XE<lt>absolutizing relative URLsE<gt>>
 ...
 C<ZE<lt>E<gt>> -- a null (zero-effect) formatting code
