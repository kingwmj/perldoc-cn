...
used in the future for all engines for optimisations.
 ...
 C<nparens>, C<lasparen>, and C<lastcloseparen>
...
the regex engine at all, and if so where in the string to search.
 ...
 C<subbeg> C<sublen> C<saved_copy>
