...
or by letting automatic decoding and encoding do all the work:
 ...
 What are C<decode_utf8> and C<encode_utf8>?
...
about it.
 ...
 What about the C<use encoding> pragma?
...
based on the user's locale, C<use open>.
 ...
 What is the difference between C<:encoding> and C<:utf8>?
...
There are some shortcuts for oneliners; see C<-C> in L<perlrun>.
 ...
 What's the difference between C<UTF-8> and C<utf8>?
