...
=over 3
 ...
 Start with F<module-starter> or F<h2xs>
...
modern testing environment, and C<-n> specifies the name of the module.
 ...
 Use L<strict|strict> and L<warnings|warnings>
...
your module at fault.
 ...
 Use L<Exporter|Exporter> - wisely!
...
export set - look at L<Exporter> for more details.
 ...
 Use L<plain old documentation|perlpod>
...
your request to be approved by the PAUSE administrators.
 ...
 C<perl Makefile.PL; make test; make dist>
