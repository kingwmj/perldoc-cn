...
=over 5
 ...
 C<$`> is the same as C<substr($var, 0, $-[0])>

 C<$&> is the same as C<substr($var, $-[0], $+[0] - $-[0])>

 C<$'> is the same as C<substr($var, $+[0])>

 C<$1> is the same as C<substr($var, $-[1], $+[1] - $-[1])>

 C<$2> is the same as C<substr($var, $-[2], $+[2] - $-[2])>

 C<$3> is the same as C<substr($var, $-[3], $+[3] - $-[3])>
