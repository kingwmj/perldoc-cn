...
=over 4
 ...
 B<PerlIO_stdin()>, B<PerlIO_stdout()>, B<PerlIO_stderr()>
...
interrupted by a signal.
 ...
 B<PerlIO_puts(f,s)>, B<PerlIO_putc(f,c)>
...
Configure value which may not be same as stdio's C<off_t>.
 ...
 B<PerlIO_getpos(f,p)>, B<PerlIO_setpos(f,p)>
