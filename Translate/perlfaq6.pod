 ...
 * Solve the balanced text problem from another question in L<perlfaq6>

 * Try the recursive regex features in Perl 5.10 and later. See L<perlre>

 * Try defining a grammar using Perl 5.10's C<(?DEFINE)> feature.
