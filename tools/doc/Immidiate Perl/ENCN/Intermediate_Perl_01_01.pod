=EN 1.1. What Should You Know Already?
=CN 1.1. 你应该已经知晓哪些概念？
...
=CN 我们会假定你已经读过《Learning Perl》，或假装你已经读过，或者你已经玩过Perl一段时间，已经把基础知识拿下。
...
=CN    * Perl的三种变量类型：标量、数据和散列

=EN    * Control structures such as while, if, for, and foreach
=CN    * 控制结构的语法如：while,if,for和foreach
